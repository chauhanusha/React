...
export default function MainCon(){
    return(
        ...
        <Header />
        <Entry 
            img={{src:"src/images/mount.png", alt:"mount fuji"}}
            title="Mount Fuji"
            country="JAPAN"
            ...
            dates="12 Jan, 2024 - 20 Jan, 2024"
            text="Mount Fuji is the tallest mountain in Japan, standing at 3,776 meters (12,380 feet). Mount Fuji is the single most popular tourist site in Japan, for both Japanese and foreign tourists. Japan is an island country in East Asia. Located in the Pacific Ocean off the northeast coast of the Asian mainland, it is bordered to the west by the Sea of Japan and extends from the Sea of Okhotsk in the north to the East China Sea in the south"
        />
        </>
    )
}